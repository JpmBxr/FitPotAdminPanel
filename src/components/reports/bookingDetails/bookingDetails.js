  ...
  data() {
    return {
      ...
      tableHeader: [
        ...
        {
          text: "Current",
          value: "in_clinic_booking_current_slot_position",
          sortable: false,
          width: "5%",
          align: "start",
        },
    ...
    getDetails() {
      ...
      sortBy =
        sortBy.length == 0
          ...
          : sortBy[0];
      ApiService.get(ApiEndPoint.BookingDetails.getBookingDetails, {
        in_clinic_booking_from_date: this.in_clinic_booking_from_date,
        in_clinic_booking_to_date: this.in_clinic_booking_to_date,
