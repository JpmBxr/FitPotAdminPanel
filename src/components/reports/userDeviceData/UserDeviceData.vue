      ...
      <v-card class="mb-10">
        ...
        <div v-show="show">
          ...
          <v-row dense class="mt-5 px-4">
            ...
            <v-col cols="3" md="3" class="px-4 my-0">
              <v-btn
                class="ma-0"
                outlined
                color="indigo"
            ...
            <template v-slot:top>
              <v-toolbar flat>
                <v-text-field
                  ...
                  v-model="searchText"
                  label="Search"
                  placeholder="Enter User Name | User Email | User Mobile No."
