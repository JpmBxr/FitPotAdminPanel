    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.comp_master_status="{ item }">
            <v-switch
              :color="item.comp_master_status == 1 ? 'green' : 'red'"
              inset
              dense
              v-model="item.comp_master_status"
            ...
            <v-card-text class="py-4 px-2">
              ...
              >
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6" >
                    <v-text-field
                      v-model="item.comp_master_total_km"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                  ...
                  <v-col cols="12" md="6" >
                    <v-text-field
                      v-model="item.comp_master_minimum_km_per_day"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.comp_master_max_participant"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.comp_master_min_participant"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.comp_master_pot_value"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                  ...
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      v-model="item.comp_activity_id"
                      :items="activityItems"
                      item-text="comp_activity_name"
                      item-value="comp_activity_id"
                      outlined
                      dense
                      chips
                      small-chips
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      v-model="item.comp_category_id"
                      :items="categoryItems"
                      item-text="comp_category_name"
                      item-value="comp_category_id"
                      outlined
                      dense
                      chips
                      small-chips
                      @change="getCompetitionType"
                      :rules="validationRulesRequired"
                      @keypress="acceptNotCharacter"
                      ><template #label>
                        Select Category
                  ...
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      v-model="item.comp_type_id"
                      :items="competitionTypeItems"
                      item-text="comp_type_name"
                      item-value="comp_type_id"
                      outlined
                      dense
                      chips
                      small-chips
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.daily_loyalty_point"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.achievers_loyalty_point"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-text-field
                      v-model="item.comp_master_per_partition_value"
                      dense
                      outlined
                      :rules="validationRulesRequired"
                      @keypress="acceptDigit"
                ...
                <v-row class="mx-4">
                  <v-col cols="12" md="6">
                    <v-autocomplete
                      v-model="item.comp_master_rest_day"
                      :items="restDayItems"
                      item-text="name"
                      item-value="id"
                      outlined
...
<script>
import { competitionMaster } from "./competitionMaster";
export default competitionMaster;
</script>
